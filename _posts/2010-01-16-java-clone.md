 ...
 *
 */
public class CloneByReflecter {
	/**
	 * 无需进行复制的特殊类型数组
	 */
	private static Class[] needlessCloneClasses = new Class[] { String.class, Boolean.class, Character.class,
