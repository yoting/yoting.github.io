...
&ensp;&ensp;&ensp;&ensp;使用mongoDB进行CRUD操作，就是通过执行响应的shell语句，所以实质上是对shell语句的使用.首先需要了解mongoDB的几种简单对象：**db,collection,document.**
...
&ensp;&ensp;&ensp;&ensp;在业务代码中直接使用mongoTemplate对象处理数据
